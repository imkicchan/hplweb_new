...
Flatter is distributed under the terms of the GNU General Public License v2
...
Flatter Theme support styling of  the following plugins from the WordPress Repository.
...
== FLATTER THEME HOMEPAGE ==
By default, WordPress site will takes you to Blog as your Homepage but in order to get the Flatter Theme Homepage, you have to go to Pages > Add New page. Here you can add title as Home and select the template as Frontpage. Then Save the page, assign that page to frontpage via settings and all done...!!!


== FLATTER THEME OPTION PANEL ==
	
Go to Appearance > Customize.
Click on Flatter Theme Option where you will get the following sections for the homepage to set.

*** Flatter Theme Option ***
...
*** Flatter Sidebar Layout ***

After successfully optimizing your site requirements from Flatter Theme Option, now you can choose your site sidebar layout option for Blog, Single page, Post page, Search page and Page not found page accordingly.
