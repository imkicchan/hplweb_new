...
get_header(); ?>
<?php $status=get_theme_mod('slider_category_status_front'); 
	if($status==0):?> 
                ...
                <div class="carousel-caption outer">
                 	<div class="middle">
                    	<div class="inner wow zoomIn" data-wow-duration="1.5s">
                    		<?php $slider_title= get_theme_mod('slider_title_status','0');
                    		if($slider_title==0):?>
                    			<h3><?php the_title();?></h3>
                    		<?php endif;?>

                    		<?php $slider_title= get_theme_mod('slider_content_status','0');
                    		if($slider_title==0):?>
                    			<?php the_excerpt();?>
                    		<?php endif;?>
                    		...
                    		<?php $slider_title= get_theme_mod('slider_readmore_status','0');
                    		if($slider_title==0):?>
	        ...
	        <div class="row">
	        	<div class="col-sm-12">
	                <div class="section-title">
	                    <h3><?php echo esc_attr(get_theme_mod( 'feature_title' )); ?></h3>
	                    <div class="underline"></div>
	                </div>
	            </div>	        
	        	<?php
					$cid = get_theme_mod('features_category_display');
					$feature_num= esc_attr(get_theme_mod('featured_category_display_num','4'));
					$category_link = get_category_link($cid);
					$flatter_cat = get_category($cid);
					if ($flatter_cat) {
	        	?>
	            ...
	            <?php
	            	if($cn%4==0){ echo '<div class="clearfix"></div>';}                 
	      			endwhile;
	    ...
	    <div class="container">
	        <div class="row">
	            ...
	            <?php
					...
					$s_num= esc_attr(get_theme_mod('service_category_display_num','4'));
					$category_link = get_category_link($cid);
					$flatter_cat = get_category($cid);
					if ($flatter_cat) {
	        	?>
	            ...
	            <div class="col-sm-12">  	            
                	<div id="owl-demo" class="owl-carousel owl-theme wow fadeInUp">
                		<?php
							...
							$t_num= esc_attr(get_theme_mod('testimonial_category_display_num','2'));
							$category_link = get_category_link($cid);
							$flatter_cat = get_category($cid);
							if ($flatter_cat) {
			        	?>
	    ...
	    <div class="container">
	        <div class="row">
	            ...
	            <?php
					...
					$l_num= esc_attr(get_theme_mod('latest_category_display_num','4'));
					$category_link = get_category_link($cid);
					$flatter_cat = get_category($cid);
					if ($flatter_cat) {
	        	?>
...
<?php $statuscta=get_theme_mod('cta_display','1');?>
	<?php if($statuscta==0): ?>
		<?php echo wpautop(get_theme_mod('cta_section'));?>
	    ...
	    <div class="container">
	        <div class="row">
	            ...
	            <?php
					...
					$our_num= esc_attr(get_theme_mod('ourwork_category_display_num','8'));
					$category_link = get_category_link($cid);
					$flatter_cat = get_category($cid);
					if ($flatter_cat) {
	        	?>
